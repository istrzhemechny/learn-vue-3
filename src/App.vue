<template>
  ...
  <div class="card">
    ...
    <button @click="wizard1.name=wizard1.name.toUpperCase()">Change name to upper case</button>
  ...
  <div class="card">
    ...
    <button @click="wizard2.name=wizard2.name.toUpperCase()">Change name to upper case</button>
